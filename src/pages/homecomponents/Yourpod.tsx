...
const YourPod: React.FC = () => {
  return (
    <section className="py-16 bg-[#1e2130] text-white">
          ...
          <div className="md:w-1/3 flex justify-center">
            <div className="relative">
              <div className="w-40 h-40 bg-[#3b3f6d]/80 rounded-full flex items-center justify-center relative">
                <div className="absolute w-[200px] h-[200px] border-4 border-purple-500 rounded-full animate-pulse" style={{ transform: 'translate(-50%, -50%)', left: '50%', top: '50%', boxShadow: '0 0 15px rgba(168, 85, 247, 0.5)' }}></div>
